    ...
    return (
        <>
            ...
            <form className="text-start w-75 griD" onSubmit={handleSubmit(onSubmit)}>
                <input placeholder='Return cutton' className='form-control rounded p-2' {...register("rQ")} />
                <input placeholder='Damage cotton' className='form-control rounded p-2' {...register("damagePrice")} />
                <input className='rounded px-3 border-0 btn-primary py-2' value={'Add Damages'} type="submit" />
            </form>
        </>
    );
};
