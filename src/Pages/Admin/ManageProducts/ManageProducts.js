    ...
    <div className="griD d-flex align-items-center justify-content-center">
      <Container>
        <div className="w-75 mx-auto border p-3">
          <h1 className="text-center mb-3 bg-primary p-3 text-light">
            পন্য আমদানি
          </h1>
          <form className="text-start w-100" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-3">
              ...
              <input
                placeholder="কার্টন সংখ্যা"
                className="form-control rounded p-2"
                {...register("cQ", { required: true })}
              />
            </div>
            <div className="mb-3">
              <label>কার্টনের ভিতরের পরিমাণ</label>
              <input
                placeholder="কার্টনের ভিতরের পরিমাণ"
                className="form-control rounded p-2"
                {...register("cIQ", { required: true })}
              />
            </div>
            <div className="mb-3">
              <label>সর্বমোট ক্রয়মূল্য</label>
              <input
                placeholder="সর্বমোট ক্রয়মূল্য"
                className="form-control rounded p-2"
            ...
            <div className="text-end w-100">
              <input
                className="rounded px-3 border-0 btn-primary py-2 text-end"
                value={"Add Product"}
                type="submit"
              />
            </div>
