...
const UpdateData = () => {
  ...
  const onSubmit = (data) => {
    ...
    newData.sellPrice = data?.sellPrice
      ? data?.sellPrice
      : singleItem?.sellPrice;
        ...
        <div className="w-75 mx-auto border px-3 pt-5">
          ...
          <form className="text-start w-100" onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-3">
              ...
              <input
                placeholder="কার্টন ডেলিভারি পরিমান"
            ...
            <div className="mb-3">
              ...
              <input
                placeholder="সর্বমোট বিক্রিত কার্টন"
                className="form-control rounded p-2"
                {...register("sQ")}
              />
            </div>
